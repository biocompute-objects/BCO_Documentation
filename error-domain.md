...
For data integration BCOs used to develop knowledgebases, the error domain can, for example, contain a record of annotations that did not pass a set of rules.
